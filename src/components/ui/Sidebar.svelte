...
<aside
    ...
    class:w-14={!$open}
    class="transition-slowest ease min-h-screen overflow-hidden border-r border-gray-100 bg-gradient-to-b from-gray-700 to-gray-800 p-0 text-gray-100 transition-width duration-300 dark:border-primary-950"
>
    <div class="flex min-h-screen flex-col justify-between">
        ...
        {#if $open}
            ...
            >
                <div
                    class="flex items-center justify-between space-x-2 px-2 py-3"
                >
                ...
                {#if openProfileMenu}
                    ...
                    >
                        <div>
                            <a
                                href="/profile"
                                class="flex items-center space-x-2 overflow-hidden px-2 py-3 font-semibold transition duration-300 hover:bg-black/10"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="none"
                        ...
                        >
                            <button
                                class="flex w-full cursor-pointer space-x-2 rounded-b-lg px-2 py-3 font-semibold transition duration-300 hover:bg-black/10"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24"
